...
/**
 * Organization Admin Preview Documentation Layout
 * Layout for organization admin-focused interactive product showcase.
 * Provides a dark theme container with sidebar placeholder for navigation.
 */
export default function OrganizationAdminPreviewLayout({
  children,
}: {
