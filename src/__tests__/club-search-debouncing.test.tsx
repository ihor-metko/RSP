...
describe("Club Search Debouncing", () => {
  ...
  it("should handle Cyrillic input correctly", async () => {
    ...
    render(
        ...
        <PublicSearchBar onSearch={mockOnSearch} />
  ...
  it("should not trigger search when syncing from URL", async () => {
    ...
    const { rerender } = render(
        ...
        <PublicSearchBar initialQ="" initialCity="" onSearch={mockOnSearch} />
    ...
    rerender(
        ...
        <PublicSearchBar initialQ="Lviv" initialCity="Kyiv" onSearch={mockOnSearch} />
  ...
  it("should clear filters and trigger single search", async () => {
    ...
    render(
        ...
        <PublicSearchBar initialQ="test" initialCity="Kyiv" onSearch={mockOnSearch} />
  ...
  it("should handle empty input correctly", async () => {
    ...
    render(
        ...
        <PublicSearchBar initialQ="test" onSearch={mockOnSearch} />
