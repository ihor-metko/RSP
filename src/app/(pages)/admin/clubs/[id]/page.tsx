      ...
      {club.organization && (
        <div className="im-club-org-context">
          <div className="im-club-org-context-content">
            <svg
              className="im-club-org-context-icon"
              width="18"
              height="18"
              viewBox="0 0 24 24"
              fill="none"
            ...
            <span className="im-club-org-context-label">{t("clubDetail.partOfOrganization")}</span>
            {adminStatus?.adminType === "root_admin" ? (
              <IMLink
                href={`/admin/organizations/${club.organization.id}`}
                className="im-club-org-context-link"
              >
                {club.organization.name}
              </IMLink>
            ) : (
              <span className="im-club-org-context-name">{club.organization.name}</span>
            )}
          </div>
        </div>
      )}
