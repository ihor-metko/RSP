...
export interface EntityBannerProps {
  ...
  /**
   * Disable the edit button (optional)
   * When true, the edit button will be disabled and show a tooltip
   */
    ...
    <section className={`rsp-club-hero ${className}`} data-testid="entity-banner">
      ...
      <div className="rsp-club-hero-content">
        ...
        {onEdit && !hideAdminFeatures && (
          editDisabled ? (
            <Tooltip content={editDisabledTooltip || t('editDisabled')}>
              <button
                disabled
                className="rsp-entity-banner-edit-btn rsp-entity-banner-edit-btn--disabled"
